...
declare -A menu_options=(
  ...
  ["Work Music"]="https://www.youtube.com/watch?v=F5Rn8EUjNf4"
  ["Hacker Music"]="https://www.youtube.com/watch?v=BNNaKMky1x4&t=79s"
)

# Function for displaying notifications
notification() {
  notify-send -u normal -i "$iDIR/music.png" --app-name="Rofi Beats" "Playing now: $@"
}

# Main function
main() {
  choice=$(printf "%s\n" "${!menu_options[@]}" | rofi -dmenu -config ~/.config/hypr/assets/themes/items_list.rasi -i -p "")
